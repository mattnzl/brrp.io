 ...
 * 
 * Note: Database operations (assignDriver, rejectWasteJob, getJobsByCompany, getMonthlyJobTotals)
 * should only be called from API routes, not from client-side code.
 */
